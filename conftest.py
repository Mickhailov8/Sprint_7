...
from helpers.generators import generate_courier_data, generate_courier_data1
...
@pytest.fixture(scope="function")
def create_and_delete_courier_without_first_without_first_name():
    courier_data = generate_courier_data1()
